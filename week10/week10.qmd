...
We can interpret the results of this odds ratio regression to mean that if we exponentiate the logged $\beta$ or logged odds differences in our groups, we can say someone supports capital punishment has much lower odds (0.19 times) of supporting Biden than the odds someone who does not support capital punishment. The 99% confidence interval for this odds ratio would be $\{0.154, 0.251\}$.
